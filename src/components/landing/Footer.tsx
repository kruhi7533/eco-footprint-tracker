    ...
    <footer className="bg-white py-16">
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <a href="/" className="inline-block">
                <div className="flex items-center">
                  <span className="text-xl">eco<span className="font-medium">step</span></span>
                </div>
              </a>
              <p className="text-gray-600 text-sm leading-relaxed">
                Making sustainability accessible and measurable for everyone.
              </p>
              <div className="space-y-2">
                <a href="mailto:contact@ecostep.com" className="text-gray-600 text-sm hover:text-gray-900 flex items-center">
                  <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  contact@ecostep.com
                </a>
                <a href="tel:+1234567890" className="text-gray-600 text-sm hover:text-gray-900 flex items-center">
                  <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor">
         ...
         <p className="text-gray-500 text-sm">© {currentYear} EcoStep. All rights reserved.</p>
